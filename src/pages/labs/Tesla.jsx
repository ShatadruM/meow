...
import Data from "../../members/tesla.json";
...
const Tesla = () => {
  ...
  <>
   ...
   <div className='h-auto'>
    <div data-nav-color="green" ref={containerRef} className="relative w-full h-screen bg-[#0b0b0b] overflow-hidden flex flex-col">
    ...
    >
      ...
      */}
      <div className="absolute w-[200vw] rotate-10 bg-[#000000] flex select-none py-6 z-10 lg:translate-y-12">
        ...
        >
          <span className="text-[12vw] md:text-[8vw] font-bebas font-bold leading-none uppercase text-[#39ff14] px-4">
            {text} {text}
          </span>
          <span className="text-[12vw] md:text-[8vw] font-bebas font-bold leading-none uppercase text-[#39ff14] px-4">
            {text} {text}
