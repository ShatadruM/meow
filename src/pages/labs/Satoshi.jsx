...
const Satoshi = () => {
  ...
  <>
   ...
   <div className='h-auto'>
    <div data-nav-color="orange" ref={containerRef} className="relative w-full h-screen bg-[#f7562b] overflow-hidden flex flex-col">
      ...
      <div className="md:w-1/3 flex flex-col w-full px-8 md:pr-20">
        ...
        <div className="flex flex-col items-start pb-16 md:pb-0 md:h-screen md:justify-start">
          <p className="text-xl md:text-3xl leading-snug text-gray-200" style={{ fontFamily: "'Inter', sans-serif" }}>
           Satoshi Lab stands at the forefront of Web3 and digital security, focusing on decentralized architectures and modern defense mechanisms. Our research encompasses cryptocurrency, malware analysis, and network security, with a specialized emphasis on penetration testing and reverse engineering. By integrating threat research with advanced cryptography and secure coding, we empower members to engineer resilient, trustless systems.   </p>
        </div>
